...
def process(velodyne_path, label_path=None, calib_path=None, data_format="pcd", label_type="txt", is_velo_cam=False):
    p = []
    pc = None
    bounding_boxes = None
    places = None
...
def lidar_generator(batch_num, velodyne_path, label_path=None, calib_path=None, resolution=0.2, data_format="pcd", label_type='txt', is_velo_cam=False, \
